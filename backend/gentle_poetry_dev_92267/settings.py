"""
Django settings for gentle_poetry_dev_92267 project.
...
ROOT_URLCONF = 'gentle_poetry_dev_92267.urls'
...
WSGI_APPLICATION = 'gentle_poetry_dev_92267.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_poetry_dev_92267 API",
    "DESCRIPTION": "API documentation for gentle_poetry_dev_92267 App",
    "VERSION": "v1",
}
